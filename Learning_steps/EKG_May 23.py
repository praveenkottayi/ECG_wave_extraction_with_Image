...
#    plt.plot(sum_part)
#    plt.show()
    extract_connected_components(img)
    for i in range(0, 3):
        index_gap = []
...
#    extracted_wave_image=image
    ...
    cv2.imwrite(input_file,extracted_wave_image)
    cv2.waitKey(0)
...
#print (" Before For loop of words ")
...
#                   print words[i+2]
                ...
                if len(words[i]) >15 and "Referred" not in words[i] and "ACCOUNT" not in words[i] and "Confirmed" not in words[i] and "EID" not in words[i] and "BRIGHAM" not in words[i] and words[i].startswith(alphabet):
#                    print words[i].replace('$',' ')
    ...
    print "..................................................................."
    #print Notes
    print (" Before formating into JSON ")
    try:
        ...
        DOB = DOB.replace('$', ' ')
        if len(ACCOUNT)>11:
            ACCOUNT=ACCOUNT.replace('$', ' ').split(':')[1]
        else :
            ACCOUNT= " "
        if len(Loc)>5 :
    ...
    print (" Before constructing JSON ")
...
#    print(".................................................")
    ...
    print (" Before writing as a json  ")
...
#                print Input_as_pdf.getNumPages()
    ...
    #                print((img.shape))
                    ...
                    try:
                        ...
                        print " Problem with input file. Either it's not an EKG file or has Overlapping or Lead is outside the Grid area."
